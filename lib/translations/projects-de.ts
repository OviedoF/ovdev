...
export const de: Record<string, ProjectI18n> = {
  ...
  giordota: {
    subtitle: 'Marketplace für Dota 2-Items mit Wetten und Gaming-Shop',
    categories: 'Web-App • Gaming • Microservices • Steam API • Astro + Svelte',
    description:
      'Handelsplattform für Dota 2-Items mit Marketplace, Wettsystem mit virtuellen Münzen, 5 Arten von Lootboxen, automatisierte Steam-Bots für den Item-Tausch, Echtzeit-Mehrkanalchat, Triple-Wallet-System, integriertes soziales Netzwerk, VIP-System mit Stufen, Discord-Bot und Zahlungsanbindungen für Peru (Mercado Pago, PayPal, PagoEfectivo). Microservice-Architektur mit Java Spring Boot, 4 Node.js-Diensten und Astro/Svelte-Frontend.',
    features: [
      {
        title: 'Marketplace und Bots',
        items: [
          'Dota 2-Item-Katalog mit Steam-Preisen',
          'Kauf und Verkauf von Items mit interner Wallet',
          'Automatisierte Steam-Bots mit Trade Offers',
          'Verwaltung mehrerer Bots mit integriertem Steam Guard',
          'Inventarüberprüfung in Echtzeit',
        ],
      },
      {
        title: 'Lootboxen und Wetten',
        items: [
          '5 Arten von Boxen: normal, gratis, sozial, Fan und Formular',
          'Öffnungsanimation mit Enthüllung des gewonnenen Items',
          'Wetten mit virtuellen Münzen auf Events und Spiele',
          'Vom Administrator konfigurierbare Wahrscheinlichkeiten',
        ],
      },
      {
        title: 'Triple Wallet und Zahlungen',
        items: [
          'Kauf-Wallet, Auszahlungs-Wallet und Gratis-Wallet',
          'Einzahlungen mit Mercado Pago, PayPal und PagoEfectivo',
          'Auszahlungen mit Antrag und Verarbeitung',
          'Vollständiger Transaktionsverlauf',
        ],
      },
      {
        title: 'Community und Chat',
        items: [
          'Echtzeit-Chat: Support, Gruppe, Admin und Schlüssel',
          'Soziales Netzwerk mit Beiträgen und Freundschaftssystem',
          'Discord-Bot mit Befehlen und Benachrichtigungen',
          'VIP-System mit Stufen und exklusiven Vorteilen',
        ],
      },
    ],
    integrationUses: [
      'Authentifizierung, Inventare und Dota 2-Item-Daten',
      'Automatisierter Item-Tausch mit Trade Offers',
      'Zahlungsanbindung für den peruanischen Markt',
      'Internationale Zahlungsanbindung',
      'Barzahlungen an Zahlstellen in Peru',
      'Erweiterte Community mit Befehlen und Benachrichtigungen',
      'Chat, Wetten und Echtzeit-Aktualisierungen',
    ],
    highlights: [
      'Microservice-Architektur: Spring Boot + 4 Node.js-Dienste',
      'Automatisierte Steam-Bots mit Trade Offers und Steam Guard',
      '5 Arten von Lootboxen mit konfigurierbaren Wahrscheinlichkeiten',
      'Triple Wallet (Kauf, Auszahlung, Gratis) für granulare Finanzkontrolle',
      'Modernes Frontend mit Astro + Svelte für SSG + Interaktivität',
      '3 Zahlungsanbindungen für Peru: Mercado Pago, PayPal und PagoEfectivo',
      'Mehrkanaliger Echtzeit-Chat mit WebSocket',
      'In die Plattform integrierter Discord-Bot',
    ],
  },
  'saucedo-abogados': {
  ...
  talenthunt: {
    subtitle: 'Recruiting-Chatbot mit KI und Lebenslauf-Parsing',
    categories: 'Web-App • Personalwesen • KI • GPT-4 • Chatbot • Laravel 12 • Filament',
    description:
      'Plattform für automatisiertes Recruiting mit konversationellem KI-Chatbot. Empfängt Kandidaten über einen konfigurierbaren Chatbot, parst Lebensläufe mit GPT-4 (automatische Extraktion von persönlichen Daten, Erfahrung und Ausbildung aus PDFs), verwaltet Bewerbungen mit Kanban-Ablauf, integriert sich mit TalentTalent API zur Veröffentlichung von Stellenangeboten, Chatbot-Flow-Builder, Analyse-Dashboard (Funnel, Time-to-Hire, Leistung pro Recruiter) und 3 Rollen. Filament-Panel.',
    features: [
      {
        title: 'Konversations-Chatbot',
        items: [
          'Konfigurierbarer Gesprächsablauf pro Stellenangebot',
          'Flow-Builder mit Schritten: offene Fragen, Multiple Choice, Dateien',
          'Dynamische Antworten basierend auf den Antworten des Kandidaten',
          'Lebenslauf-Upload direkt im Gespräch',
          'Chatartige Oberfläche, benutzerfreundlich für Kandidaten',
        ],
      },
      {
        title: 'Lebenslauf-Parsing mit GPT-4',
        items: [
          'Automatische Texterkennung in PDFs mittels OCR',
          'Extraktion persönlicher Daten: Name, E-Mail, Telefon, Standort',
          'Extraktion beruflicher Erfahrung: Unternehmen, Positionen, Zeiträume',
          'Identifizierung technischer und sozialer Kompetenzen',
          'Automatische Felder im Kandidatenprofil gespeichert',
        ],
      },
      {
        title: 'Bewerbungsverwaltung',
        items: [
          'Kanban: neu → Prüfung → Interview → Test → Angebot → eingestellt',
          'Kandidatendetail mit geparstem Lebenslauf und Chatbot-Antworten',
          'Interne Recruiter-Notizen und vollständige Timeline',
          'Zuweisung von Bewerbungen an Recruiter',
        ],
      },
      {
        title: 'Analyse und Administration',
        items: [
          'Konversionsfunnel: Besuche → Bewerbungen → Einstellungen',
          'Time-to-Hire und Leistung pro Recruiter',
          'Veröffentlichung von Stellenangeboten auf Portalen über TalentTalent API',
          '3 Rollen: Administrator, Recruiter, Betrachter (Filament)',
        ],
      },
    ],
    integrationUses: [
      'Intelligentes Lebenslauf-Parsing: Daten, Erfahrung, Ausbildung und Fähigkeiten',
      'Veröffentlichung von Stellenangeboten auf mehreren Jobportalen',
      'Administrationspanel mit Dashboard und Ressourcenverwaltung',
      'Interaktivität des Chatbots und dynamische Komponenten',
      'Generierung von Berichten als PDF',
    ],
    highlights: [
      'Lebenslauf-Parsing mit GPT-4: automatische Extraktion von Daten, Erfahrung und Fähigkeiten',
      'Visueller Chatbot-Flow-Builder ohne Programmierkenntnisse',
      'Analyse-Dashboard: Konversionsfunnel, Time-to-Hire, Leistung pro Recruiter',
      'Integration mit TalentTalent API zur Veröffentlichung auf mehreren Portalen',
      '3 differenzierte Rollen: Administrator, Recruiter und Betrachter',
      'Filament v3.3 als Hauptpanel mit professionellem Dashboard',
      'Vollständiger Kanban-Ablauf zur visuellen Kandidatenverwaltung',
      'Laravel 12 mit Alpine.js, Livewire und Tailwind CSS v4',
    ],
  },
  biznes: {
